...
void glBindAttribLocation(
    int program, int index, String name) native "glBindAttribLocation";
...
void glBindRenderbuffer(
    int target, int renderbuffer) native "glBindRenderbuffer";
void glBindTexture(int target, int texture) native "glBindTexture";
void glBlendColor(
    double red, double green, double blue, double alpha) native "glBlendColor";
void glBlendEquation(int mode) native "glBlendEquation";
void glBlendEquationSeparate(
    int modeRGB, int modeAlpha) native "glBlendEquationSeparate";
...
void glBufferData(
    int target, int size, TypedData data, int usage) native "glBufferData";
void glBufferSubData(
    int target, int offset, int size, TypedData data) native "glBufferSubData";
int glCheckFramebufferStatus(int target) native "glCheckFramebufferStatus";
void glClear(int mask) native "glClear";
void glClearColor(
    double red, double green, double blue, double alpha) native "glClearColor";
void glClearDepthf(double d) native "glClearDepthf";
void glClearStencil(int s) native "glClearStencil";
void glColorMask(
    bool red, bool green, bool blue, bool alpha) native "glColorMask";
...
void glDrawElements(
    int mode, int count, int type, TypedData indices) native "glDrawElements";
...
int glGetUniformLocation(
    int program, String name) native "glGetUniformLocation";
...
void glStencilFuncSeparate(
    int face, int func, int ref, int mask) native "glStencilFuncSeparate";
...
void glStencilOpSeparate(
    int face, int sfail, int dpfail, int dppass) native "glStencilOpSeparate";
void glTexImage2D(int target, int level, int internalformat, int width,
    int height, int border, int format, int type,
    TypedData pixels) native "glTexImage2D";
void glTexParameterf(
    int target, int pname, double param) native "glTexParameterf";
...
void glUniform1fv(
    int location, int count, TypedData value) native "glUniform1fv";
void glUniform1i(int location, int v0) native "glUniform1i";
void glUniform1iv(
    int location, int count, TypedData value) native "glUniform1iv";
void glUniform2f(int location, double v0, double v1) native "glUniform2f";
void glUniform2fv(
    int location, int count, TypedData value) native "glUniform2fv";
void glUniform2i(int location, int v0, int v1) native "glUniform2i";
void glUniform2iv(
    int location, int count, TypedData value) native "glUniform2iv";
void glUniform3f(
    int location, double v0, double v1, double v2) native "glUniform3f";
void glUniform3fv(
    int location, int count, TypedData value) native "glUniform3fv";
void glUniform3i(int location, int v0, int v1, int v2) native "glUniform3i";
void glUniform3iv(
    int location, int count, TypedData value) native "glUniform3iv";
void glUniform4f(int location, double v0, double v1, double v2,
    double v3) native "glUniform4f";
void glUniform4fv(
    int location, int count, TypedData value) native "glUniform4fv";
void glUniform4i(
    int location, int v0, int v1, int v2, int v3) native "glUniform4i";
void glUniform4iv(
    int location, int count, TypedData value) native "glUniform4iv";
...
void glVertexAttrib3f(
    int index, double x, double y, double z) native "glVertexAttrib3f";
...
void glVertexAttrib4f(int index, double x, double y, double z,
    double w) native "glVertexAttrib4f";
